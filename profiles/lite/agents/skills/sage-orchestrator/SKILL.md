...
description: Orchestrate multi-step Codex coding work (Lite profile: gpt-5.6-luna medium root, gpt-5.6-luna low execution roles, gpt-5.6-luna medium critic). Use for multi-file features, cross-component debugging, repo-wide changes, parallel workstreams, or when the user asks for subagents. Skip for single-file edits and plain questions.
---

# Sage Orchestrator (Lite profile)
...
```text
root      gpt-5.6-luna  medium  plans, integrates, verifies
scout     gpt-5.6-luna  low     read-only mapping
builder   gpt-5.6-luna  low     bounded implementation
verifier  gpt-5.6-luna  low     tests and reproduction
scholar   gpt-5.6-luna  low     external facts
critic    gpt-5.6-luna  medium  independent review
```
...
- Stay within the configured concurrency (2) and parallelize only truly independent work.
